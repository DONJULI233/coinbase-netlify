            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-yellow-800">
                  <strong>Demo Project:</strong> This is a student project for educational purposes only. Do not enter real cryptocurrency data, wallet addresses, or any sensitive information.
                </p>
              </div>
            </div>
          </div>
